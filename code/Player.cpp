...
void Player::draw(Graphics &graphics) {
	SDL_Rect rect = {(i32)(collider.pos.x / 3), (i32)(collider.pos.y / 3), (i32)(collider.size.w / 3), (i32)(collider.size.h / 3)};
...
void Player::simulate(types::r32 dt, Map &map) {
	...
	Camera::get_instance().get_pos() = Vec2f(1280.f/2, 720.f/2) - pos;//graphics.get_display_resolution();
}
